...
def main():
    ...
    # cs for computer science and engineering
    # is for information science and engineering
    # cv for civil engineering
    # me for mechanical engineering
    # ec for electronics and communication engineering
    # ee for electrical and electronics engineering
    # te for telecommunication engineering
    # ae for aeronautical engineering
    # au for automobile engineering
    # bm for biomedical engineering
    # bt for bio technology 
    # ch for chemical engineering
    # ev for environmental engineering
    # im for industrial engineering and management
    # ip for industrial and production engineering
    # it for instrumentation technology
    # ma for manufacturing science and engineering
    # ml for medical electronics
    # tr for transport engineering
